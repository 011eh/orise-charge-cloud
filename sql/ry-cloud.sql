...
CREATE TABLE `sys_area`  (
  ...
  `name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '区域名称',
  `e_prefix` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '拼音首字母',
  `e_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '拼音名称',
  `ext_id` bigint NULL DEFAULT NULL COMMENT '对外区域ID',
  `ext_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '区域对外名称',
...
INSERT INTO `sys_logininfor` VALUES (1900436076917424130, '000000', 'admin', 'pc', 'pc', '127.0.0.1', '内网IP', 'MSEdge', 'Windows 10 or Windows Server 2016', '1', '密码输入错误1次', '2025-03-14 14:37:24');
INSERT INTO `sys_logininfor` VALUES (1900436191795216385, '000000', 'admin', 'pc', 'pc', '127.0.0.1', '内网IP', 'MSEdge', 'Windows 10 or Windows Server 2016', '1', '验证码错误', '2025-03-14 14:37:51');
INSERT INTO `sys_logininfor` VALUES (1900436202968842242, '000000', 'admin', 'pc', 'pc', '127.0.0.1', '内网IP', 'MSEdge', 'Windows 10 or Windows Server 2016', '1', '密码输入错误2次', '2025-03-14 14:37:54');
INSERT INTO `sys_logininfor` VALUES (1900436727688855554, '000000', 'admin', 'pc', 'pc', '127.0.0.1', '内网IP', 'MSEdge', 'Windows 10 or Windows Server 2016', '1', '密码输入错误3次', '2025-03-14 14:39:59');
INSERT INTO `sys_logininfor` VALUES (1900436743539130370, '000000', 'admin', 'pc', 'pc', '127.0.0.1', '内网IP', 'MSEdge', 'Windows 10 or Windows Server 2016', '1', '验证码已失效', '2025-03-14 14:40:03');
INSERT INTO `sys_logininfor` VALUES (1900436769401208834, '000000', 'admin', 'pc', 'pc', '127.0.0.1', '内网IP', 'MSEdge', 'Windows 10 or Windows Server 2016', '0', '登录成功', '2025-03-14 14:40:09');
