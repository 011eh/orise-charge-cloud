...
) ENGINE = InnoDB AUTO_INCREMENT = 3460337 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '基础平台数据——充电接口实时监测数据表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of plat_connector_realtime_data
-- ----------------------------
...
) ENGINE = InnoDB AUTO_INCREMENT = 41 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '充电订单信息表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 45 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '充电订单计费信息明细表（分时段数组）' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 122 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '充电设备接口信息表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_equipment` VALUES (6, '24110108100006', '24110108100006', '11010810001', 0, 'MA01D1QR8', '奥陌科技', 'A1', NULL, 1, 0.000000, 0.000000, 120.0, 1.00, 0, NULL, 'A6直流桩', 0, 0, '2024-01-23 17:01:17', '172.25.0.122', '2024-01-05 16:19:24', 1, '2025-03-14 15:29:46', 1, 0, '000000');
...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '基础设施运营商信息表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '充电站信息表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 32 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '站点-价格模型关联表' ROW_FORMAT = Dynamic;
