...
create table omind_wallet (
    ...
    available_balance   decimal(10, 2)                         default 0.00              not null comment '可用余额(不含赠送金额)',
    ...
    total_gift_received decimal(10, 2)                         default 0.00              not null comment '累计获得赠送金额',
    total_gift_consumed decimal(10, 2)                         default 0.00              not null comment '累计消费赠送金额',
    total_consume       decimal(10, 2)                         default 0.00              not null comment '累计消费金额',
